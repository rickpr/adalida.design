...
const KeyLearnings = forwardRef((_props: Record<never, never>, ref: Ref<HTMLDivElement>): JSX.Element => (
  <div data-aos='fade-up' className='gaintain-key-learnings' ref={ref}>
    <h2>Key Learnings</h2>
    <div>
...
KeyLearnings.displayName = 'KeyLearnings'
