...
const text = `My background in UX design, research, and technical communication, with an interdisciplinary B.A. in English-Philosophy, shapes how I analyze data, synthesize insights, and refine user experiences.
